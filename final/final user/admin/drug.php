                        ...
                        <ul class="nav side-menu">
                            ...
                            <li><a><i class="fa fa-edit"></i> Drugs Types <span class="fa fa-chevron-down"></span></a>
                                <ul class="nav child_menu">
                                    <li><a href="../php-mysql-crud-operations-hack/company.php"> Company </a></li>
                                    <li><a href="../php-mysql-crud-operations-hack/drug.php"> drugs </a></li>
                                    <li><a href="../php-mysql-crud-operations-hack/certification.php">certification</a></li>
                                    <li><a href="../php-mysql-crud-operations-hack/license.php"> license </a></li>
                                </ul>
                            </li>
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                ...
                                <div class="form-group">
                                    <label for="approve_drug_name">Drug Name</label>
                                    <input type="text" id="approve_drug_name" placeholder="Drug Name" class="form-control" disabled/>
                                </div>

                                <div class="form-group">
                                    <label for="approve_usage">Usage</label>
                                    <input type="text" id="approve_usage" placeholder="Usage" class="form-control" disabled/>
                                </div>

                                <div class="form-group">
                                    <label for="approve_dosage">Dosage</label>
                                    <input type="text" id="approve_dosage" placeholder="Dosage" class="form-control" disabled/>
                                </div>

                                <div class="form-group">
                                    <label for="approve_ingredients">Ingredients</label>
                                    <input type="text" id="approve_ingredients" placeholder="Ingredients" class="form-control" disabled/>
                                </div>

                                <div class="form-group">
                                    <label for="approve_drug_price">Drug Price</label>
                                    <input type="text" id="approve_drug_price" placeholder="Drug Price" class="form-control" disabled/>
                                </div>

                            </div>
                            <div class="modal-footer">
                                <button type="button" class="btn btn-default" data-dismiss="modal">Cancel</button>
                                <button type="button" class="btn btn-primary" onclick="ApproveDrugDetails()" >Approve</button>
