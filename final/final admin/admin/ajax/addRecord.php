<?php
	if(isset($_POST['drug_name']) && isset($_POST['usage']) && isset($_POST['dosage']) && isset($_POST['ingredients']) && isset($_POST['drug_price']))
	{
		...
		$query = "INSERT INTO drug_details(DrugName, DrugUsage, Dosage, Ingredients, Price, Company, DrugType, ApprovalStatus) VALUES('$first_name', '$last_name', '$email', '$email1', '$email2',1,2,'pending')";
