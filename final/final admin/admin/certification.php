    ...
    <div class="main_container">
        ...
        <div class="right_col" role="main">
            ...
            <div class="right_col" role="main">
                ...
                <div class="modal fade" id="approve_user_modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                ...
                                <div class="form-group">
                                    <label for="approve_certification_name">Certification Name</label>
                                    <input type="text" id="approve_certification_name" placeholder="Certification Name" class="form-control" disabled/>
                                </div>

                                <div class="form-group">
                                    <label for="approve_license_number">License Number</label>
                                    <input type="text" id="approve_license_number" placeholder="License Number" class="form-control" disabled/>
                                </div>

                                <div class="form-group">
                                    <label for="approve_company_name">Company Name</label>
                                    <input type="text" id="approve_company_name" placeholder="Company Name" class="form-control" disabled/>
                                </div>


                                <div class="form-group">
                                    <label for="approve_company_name">License Validity Date</label>
                                    <input type="text" id="licenseValidityDate" placeholder="Company Name" class="form-control" disabled/>
                                </div>


                                <div class="form-group">
                                    <label for="approve_company_name">Certification Validity Date</label>
                                    <input type="text" id="certificationValidityDate" placeholder="Company Name" class="form-control" disabled/>
                                </div>


                                <div class="form-group">
                                    <label for="approve_company_name">Certification Validity Status</label>
                                    <input type="text" id="certificationValidityStatus" placeholder="Company Name" class="form-control" disabled/>
                                </div>

                            </div>
                            <div class="modal-footer">
                                <button type="button" class="btn btn-default" data-dismiss="modal">Cancel</button>
                                <button type="button" class="btn btn-primary" onclick="ApproveCertificationDetails()" >Approve</button>
...
<script src="../Content/js/jquery.flot.stack.js">../
